...
### Teamarbeit:
#### Aufgabe 2)
In der zweiten Aufgabe wurde immer verlangt, die Vorlesungsvideos nach den Themen zu unterteilen. Dabei musste bei einem neuen Abschnitt die genaue Sekundenanzahl angegeben werden, wobei pro Übungsblatt eine bestimmte Menge an Videos strukturiert werden mussten. Im ersten Übungsblatt waren es die Videos       ‘PR2 00‘ bis ‘PR2 02-02‘ die zu bearbeiten waren. Hier finden Sie die Links zu den Videos:
#### Aufgabe 3)
...
####  Aufgabe 4a)
In der ersten Teilaufgabe 4a) mussten zur jeder Klasse im UML-Klassendiagramm (Welches das UNO Programm skizzierte) testgetriebene JUnit-Tests erstellt werden. Den Link zum Klassendiagramm finden Sie hier:
#### Aufgabe 4b)
